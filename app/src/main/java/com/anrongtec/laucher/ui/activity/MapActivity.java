...
public class MapActivity extends ToolBarActivity {
    ...
    @BindView(R.id.tv_map_main_search)
    ...
    @OnClick({R.id.rb_map_task, R.id.rb_map_resource, R.id.rb_map_meeting})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rb_map_task:
                break;
            case R.id.rb_map_resource:
                break;
            case R.id.rb_map_meeting:
                break;
            default:
                break;
        }
